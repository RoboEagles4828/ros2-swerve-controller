...
class ImportBot(BaseSample):
    ...
    def configure_robot(self, robot_prim_path):
        ...
        set_drive_params(front_left_axle, 10000000.0, 100000.0, 0.0)
        set_drive_params(front_right_axle, 10000000.0, 100000.0, 0.0)
        set_drive_params(back_left_axle, 10000000.0, 100000.0, 0.0)
        set_drive_params(back_right_axle, 10000000.0, 100000.0, 0.0)
